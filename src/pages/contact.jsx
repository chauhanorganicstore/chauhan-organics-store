...
export default function ContactPage() {
  const title = "Contact — Chauhan Organic Store";
  const desc = "Contact Chauhan Organic Store (Vijay Chauhan) — Panipat, Haryana. Email: vijaychauhan200104@gmail.com";

  return (
    <div>
      <Seo title={title} description={desc} url={(typeof window !== "undefined" ? window.location.href : "/contact")} image="/images/placeholder.svg" />
